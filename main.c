//The program is written on and compiled with Code::Blocks and should be tested on the same.
...
void PrintMonth(int year, int month, int print_to_file) {
    ...
    //Formula for calculating day taken from http://mathforum.org/dr.math/faq/faq.calendar.html
